...
public class ProcessList{
	...
	//URL url = new Process().getClass().getResource(pathway);
	...
	public String getPathFile()throws IOException{	
		String path = "";
		try{
			//iss = getClass().getClassLoader().getResourceAsStream("read.txt");
			//System.out.println(getClass().getClassLoader().getResourceAsStream("read.txt"));
